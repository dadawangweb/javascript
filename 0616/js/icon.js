/**
 * Created by wang.ding on 2017/6/26.
 */
$(function () {
    $.getJSON('https://data.jianshukeji.com/jsonp?filename=json/usdeur.json&callback=?', function (data) {
        $('#container1').highcharts({
            ...
            series: [{
                ...
                name: '美元兑欧元',
                data: [
                    {x:Date.UTC(2013,5,2),y:0.7695, marker: {
                ...
                data:[
                    {x:Date.UTC(2013,5,2),y:0.7695, marker: {
                        symbol: 'url(http://localhost:63342/githubsync/javaScript/img/dw.png)'
                    }},
                    {x:Date.UTC(2013,7,2),y:0.7529, marker: {
                        symbol: 'url(http://localhost:63342/githubsync/javaScript/img/niu.png)'
                    }},
                    {x:Date.UTC(2013,8,10),y:0.7537, marker: {
                        symbol: 'url(http://localhost:63342/githubsync/javaScript/img/japan.png)'
                    }},
                    {x:Date.UTC(2014,2,27),y:0.7278, marker: {
                        symbol: 'url(http://localhost:63342/githubsync/javaScript/img/juhui.png)'
                    }},
                    {x:Date.UTC(2014,6,10),y:0.7348, marker: {
                        symbol: 'url(http://localhost:63342/githubsync/javaScript/img/fuhuojie.png)'
                    }},
                    {x:Date.UTC(2014,8,12),y:0.7713, marker: {
                        symbol: 'url(http://localhost:63342/githubsync/javaScript/img/sd.png)'
                    }},
                ]
            }]
        });
